...
def parse_args():
    ...
    parser.add_argument("--transport",choices=["stdio", "sse", "stream"], default="stdio", help="Transport mode")
    ...
    parser.add_argument("--unify", type=str, default="false", help="Open a route for all tools to one server")
